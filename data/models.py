...
class CrsCurrent(models.Model):
    ...
    usd_commitment = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    usd_disbursement = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    usd_received = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    usd_commitment_deflated = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    usd_disbursement_deflated = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    usd_received_deflated = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    usd_adjustment = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    usd_adjustment_deflated = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    usd_amount_untied = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    usd_amount_partial_tied = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    usd_amount_tied = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    usd_amount_untied_deflated = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    usd_amount_partial_tied_deflated = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    usd_amount_tied_deflated = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    usd_irtc = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    usd_expert_commitment = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    usd_expert_extended = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    usd_export_credit = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    currency_code = models.SmallIntegerField()
    commitment_national = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    disbursement_national = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    grant_equivalent = models.TextField(blank=True, null=True)
    usd_grant_equivalent = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    ...
    grant_element = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    usd_interest = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    usd_outstanding = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    usd_arrears_principal = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    usd_arrears_interest = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    usd_future_debt_service_principal = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    usd_future_debt_service_interest = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    rmnch = models.SmallIntegerField(blank=True, null=True)
    budget_identifier = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
    capital_expenditure = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
...
class Dac1Current(models.Model):
    ...
    year = models.SmallIntegerField()
    value = models.DecimalField(max_digits=65535, decimal_places=999, blank=True, null=True)
