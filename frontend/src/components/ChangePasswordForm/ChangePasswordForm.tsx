          ...
          ({ errors, handleChange, handleSubmit, values }: FormikProps<ChangePasswordFields>) => {
            ...
            return (
              <Form className="form" noValidate onSubmit={ handleSubmit } data-testid="operation-step-form">
                ...
                <Col>
                  <Form.Group className={ this.getFormGroupClasses('old_password', values.old_password) }>
                ...
                <Col>
                  <Form.Group className={ this.getFormGroupClasses('new_password1', values.new_password1) }>
                ...
                <Col>
                  <Form.Group className={ this.getFormGroupClasses('new_password2', values.new_password2) }>
                ...
                <Col md={ 12 } className="mt-3">
                  <Button variant="danger" className="float-right" type="submit" hidden={ !this.props.editable }>
