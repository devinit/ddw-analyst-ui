...
urlpatterns = [
    ...
    path('queries/build/advanced/', views.index),
    path('queries/build/basic/', views.index),
    path('queries/build/', views.index),
    path('queries/build/advanced/<int:pk>/', views.with_id),
    path('queries/build/basic/<int:pk>/', views.with_id),
