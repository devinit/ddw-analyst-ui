...
recip_data = recip_data[['Donor Name','Purpose Name','Recipient Name',2017,2018,2019,2020, 2021]]
...
for donor in list(set(recip_data["Donor Name"])):
    for purpose in list(set(recip_data["Purpose Name"])):
        ...
        subset = subset.sort_values(by=[2021,2020,2019,2018,2017,"Recipient Name"],ascending = [False,False,False,False,False,True]).reset_index()
        subset["Rank"] = subset.index + 1 # rank by years
        recipient_data.append(subset)

recipient_data = pd.concat(recipient_data)

recipient_data.columns = ["remove","index","donor_name","Code type","recipient_name",2017,2018,2019,2020,2021,"rank"]

recipient_data = recipient_data[["donor_name","Code type","recipient_name",2017,2018,2019,2020,2021,"rank"]]
