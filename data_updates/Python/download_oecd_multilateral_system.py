...
url = "https://stats.oecd.org/DownloadFiles.aspx?DatasetCode=MULTISYSTEM"
...
content_directory = "Multilateral_"+download_date
...
for file in to_get:
    ...
    print("Downloading OECD \"Members\' total use of the multilateral system\" data:\t\t", file)
    ...
    urllib.request.urlretrieve(uri, name,reporthook)
