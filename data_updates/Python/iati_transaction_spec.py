...
DTYPES = {
    ...
    'funding_orgs': 'object',
    'accountable_orgs': 'object',
    'extending_orgs': 'object',
    'implementing_orgs': 'object',
...
class IatiFlat(object):
    def __init__(self):
        ...
        self.dictionaries["donor_transaction_type"] = {
            "2": "Commitment",
            "3": "Spend",
            "4": "Spend",
            "8": "Spend"
    ...
    def flatten_activities(self, root):
        ...
        for i in range(0, activity_len):
            ...
            recipient_country_vocabulary_list = [""] * len(recipient_country_code_list)
            ...
            funding_org_list = list()
            accountable_org_list = list()
            extending_org_list = list()
            implementing_org_list = list()
            ...
            for participating_org in participating_orgs:
                ...
                if p_name != "":
                    if role == "1":
                        funding_org_list.append(p_name)
                    elif role == "2":
                        accountable_org_list.append(p_name)
                    elif role == "3":
                        extending_org_list.append(p_name)
                    elif role == "4":
                        implementing_org_list.append(p_name)
            funding_orgs = "|".join(funding_org_list)
            accountable_orgs = "|".join(accountable_org_list)
            extending_orgs = "|".join(extending_org_list)
            implementing_orgs = "|".join(implementing_org_list)
            ...
            if has_transactions:
                ...
                for transaction in transactions:
                    ...
                    if transaction_recipient_region_vocabulary is None or transaction_recipient_region_vocabulary == "":
                        transaction_recipient_region_vocabulary = "1"
                    ...
                    x_recipient_vocabulary_list = list()
                    ...
                    if len(x_country_code_list) > 0:
                        ...
                        x_recipient_vocabulary_list = x_country_vocabulary_list.copy()
                        ...
                        if country_percentage_sum < 100:
                            ...
                            x_recipient_vocabulary_list += x_region_vocabulary_list.copy()
                    ...
                    if len(x_recipient_code_list) > 0:  # Has recipients
                        for k in range(0, len(x_recipient_code_list)):
                            ...
                            x_recipient_vocabulary = x_recipient_vocabulary_list[k]
