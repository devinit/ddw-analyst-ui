...
import os
import time
import urllib.request as RemoteTable2a
...
url = "https://stats.oecd.org/DownloadFiles.aspx?DatasetCode=TABLE2A"

# Open the web page.
html = RemoteTable2a.urlopen(url).read()
...
# Create a folder in the current directory named with the download date. Append the crs file category on it
current_directory = os.getcwd()
content_directory = "Table2a_"+download_date
...
for file in to_get:
    ...
    print("Downloading OECD DAC Table 2a:\t\t", file)
    ...
    RemoteTable2a.urlretrieve(uri, name,reporthook)
