...
import os
import time
import urllib.request as RemoteTable2b
...
url = "https://stats.oecd.org/DownloadFiles.aspx?DatasetCode=TABLE2B"

# Open the web page.
html = RemoteTable2b.urlopen(url).read()
...
content_directory = "Table2b_"+download_date
...
for file in to_get:
    ...
    print("Downloading OECD DAC Table 2b:\t\t", file)
    ...
    RemoteTable2b.urlretrieve(uri, name)
