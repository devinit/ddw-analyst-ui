...
import os
import time
import urllib.request as RemoteTable1
...
# Open the web page.
html = RemoteTable1.urlopen(url).read()
...
content_directory = "Table1_"+download_date
...
for file in to_get:
    ...
    print("Downloading OECD DAC Table 1:\t\t", file)
    ...
    RemoteTable1.urlretrieve(uri, name,reporthook)
