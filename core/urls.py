...
urlpatterns = [
    ...
    path('schedule_event/', core_views.ScheduledEventList.as_view()),
    path('scheduled_event_run_instance_list/', core_views.ScheduledEventRunInstanceList.as_view()),
    path('scheduled_event_run_instance_list/<int:pk>/', core_views.ScheduledEventRunInstanceDetail.as_view()),
    path('scheduled_event_run_instance_list/history/<int:schedule_event_id>/', core_views.ScheduledEventRunInstanceHistory.as_view()),
