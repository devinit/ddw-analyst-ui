...
insert into core_sourcecolumnmap (source_id,name,source_name,description,created_on,updated_on)
VALUES
(1,'year','Year','Reporting year',now(),now()),
(1,'donor_code','DonorCode','Reporting country/organisation',now(),now()),
(1,'donor_name','DonorName','Reporting country/organisation',now(),now()),
(1,'agency_code','AgencyCode','Extending agency',now(),now()),
(1,'agency_name','AgencyName','Extending agency',now(),now()),
(1,'crs_id','CRSid','CRS Identification number',now(),now()),
(1,'project_number','ProjectNumber','Donor project number',now(),now()),
(1,'initial_report','InitialReport','Nature of submission',now(),now()),
(1,'recipient_code','RecipientCode','Recipient',now(),now()),
(1,'recipient_name','RecipientName','Recipient',now(),now()),
(1,'region_code','RegionCode','Recipient',now(),now()),
(1,'region_name','RegionName','Recipient',now(),now()),
(1,'income_group_code','IncomegroupCode','Recipient',now(),now()),
(1,'income_group_name','IncomegroupName','Recipient',now(),now()),
(1,'flow_code','FlowCode','? (Type of flow)',now(),now()),
(1,'flow_name','FlowName','? (Type of flow)',now(),now()),
(1,'bilateral_multilateral','bi_multi','Bi/Multi',now(),now()),
(1,'category','Category','Type of flow',now(),now()),
(1,'finance_type','Finance_t','Type of finance',now(),now()),
(1,'aid_type','Aid_t','Type of aid',now(),now()),
(1,'usd_commitment','usd_commitment','',now(),now()),
(1,'usd_disbursement','usd_disbursement','Commitments',now(),now()),
(1,'usd_received','usd_received','Amounts extended',now(),now()),
(1,'usd_commitment_deflated','usd_commitment_defl','Amounts received',now(),now()),
(1,'usd_disbursement_deflated','usd_disbursement_defl','Commitments',now(),now()),
(1,'usd_received_deflated','usd_received_defl','Amounts extended',now(),now()),
(1,'usd_adjustment','usd_adjustment','Amounts received',now(),now()),
(1,'usd_adjustment_deflated','usd_adjustment_defl','',now(),now()),
(1,'usd_amount_untied','usd_amountuntied','Amount untied',now(),now()),
(1,'usd_amount_partial_tied','usd_amountpartialtied','Amount partially untied',now(),now()),
(1,'usd_amount_tied','usd_amounttied','Amount tied',now(),now()),
(1,'usd_amount_untied_deflated','usd_amountuntied_defl','Amount untied',now(),now()),
(1,'usd_amount_partial_tied_deflated','usd_amountpartialtied_defl','Amount partially untied',now(),now()),
(1,'usd_amount_tied_deflated','usd_amounttied_defl','Amount tied',now(),now()),
(1,'usd_irtc','usd_IRTC','Amount of IRTC',now(),now()),
(1,'usd_expert_commitment','usd_expert_commitment','If project-type, amount of experts_commitments',now(),now()),
(1,'usd_expert_extended','usd_expert_extended','If project-type, amount of experts_extended',now(),now()),
(1,'usd_export_credit','usd_export_credit','Amount of export credit in AF package',now(),now()),
(1,'currency_code','CurrencyCode','Currency',now(),now()),
(1,'commitment_national','commitment_national','Commitments',now(),now()),
(1,'disbursement_national','disbursement_national','Amounts extended',now(),now()),
(1,'grant_equivalent','GrantEquiv','',now(),now()),
(1,'usd_grant_equivalent','usd_GrantEquiv','',now(),now()),
(1,'short_description','ShortDescription','Short description/Project title',now(),now()),
(1,'project_title','ProjectTitle','Short description/Project title',now(),now()),
(1,'purpose_code','PurposeCode','Sector/Purpose code',now(),now()),
(1,'purpose_name','PurposeName','Sector/Purpose code',now(),now()),
(1,'sector_code','SectorCode','Sector/Purpose code',now(),now()),
(1,'sector_name','SectorName','Sector/Purpose code',now(),now()),
(1,'channel_code','ChannelCode','Channel code',now(),now()),
(1,'channel_name','ChannelName','Channel of delivery',now(),now()),
(1,'channel_reported_name','ChannelReportedName','Channel of delivery',now(),now()),
(1,'parent_channel_code','ParentChannelCode','',now(),now()),
(1,'geography','Geography','Geographical target area',now(),now()),
(1,'expected_start_date','ExpectedStartDate','Expected starting date',now(),now()),
(1,'completion_date','CompletionDate','Expected completion date',now(),now()),
(1,'long_description','LongDescription','Description',now(),now()),
(1,'gender','Gender','Gender equality',now(),now()),
(1,'environment','Environment','Aid to environment',now(),now()),
(1,'trade','Trade','Trade development',now(),now()),
(1,'pdgg','Pdgg','PD/GG',now(),now()),
(1,'ftc','FTC','FTC',now(),now()),
(1,'pba','PBA','Programme-based approach',now(),now()),
(1,'investment_project','InvestmentProject','Investment',now(),now()),
(1,'associated_finance','AssocFinance','Associated financing',now(),now()),
(1,'biodiversity','biodiversity','Biodiversity',now(),now()),
(1,'climate_mitigation','climateMitigation','Climate change – mitigation',now(),now()),
(1,'climate_adaptation','climateAdaptation','Climate change – adaptation',now(),now()),
(1,'desertification','desertification','Desertification',now(),now()),
(1,'commitment_date','commitmentdate','',now(),now()),
(1,'type_repayment','typerepayment','Type of repayment',now(),now()),
(1,'number_repayment','numberrepayment','Number of repayments per annum',now(),now()),
(1,'interest_1','interest1','Interest rate',now(),now()),
(1,'interest_2','interest2','Second interest rate',now(),now()),
(1,'repay_date_1','repaydate1','First repayment date',now(),now()),
(1,'repay_date_2','repaydate2','Final repayment date',now(),now()),
(1,'grant_element','grantelement','',now(),now()),
(1,'usd_interest','usd_interest','Interest received',now(),now()),
(1,'usd_outstanding','usd_outstanding','Principal disbursed and still outstanding',now(),now()),
(1,'usd_arrears_principal','usd_arrears_principal','Arrears of principal (included in field 5)',now(),now()),
(1,'usd_arrears_interest','usd_arrears_interest','Arrears of interest',now(),now()),
(1,'usd_future_debt_service_principal','usd_future_DS_principal','',now(),now()),
(1,'usd_future_debt_service_interest','usd_future_DS_interest','',now(),now()),
(1,'rmnch','RMNCH','',now(),now()),
(1,'budget_identifier','BudgetIdent','',now(),now()),
(1,'capital_expenditure','CapitalExpend','',now(),now());
